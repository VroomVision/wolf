							...
							<div className="flex items-center justify-center mb-6">
								...
								/>
											...
											{cart.length === 0 ? (
												...
												<div className="flex flex-col gap-8 mt-8" style={{paddingBottom: '64px'}}>
													{cart.map(item => (
														<React.Fragment key={item.product.id}>
															<div className="flex flex-row items-center gap-6 px-2">
																<img src={item.product.imageUrl[0]} alt={item.product.name} className="w-28 h-32 object-cover rounded-lg shadow" />
																<div className="flex-1 flex flex-col justify-center">
																	...
																	<div className="flex items-center gap-2 mt-2">
																		...
																		<div className="w-full absolute bottom-0 left-0 pb-8 px-6 flex flex-col items-center">
																			<div className="w-full" style={{background: '#1a1333', borderRadius: '12px', padding: '8px', marginBottom: '0'}}>
																			...
																			<div className="flex justify-center w-full min-w-0" style={{background: '#1a1333', borderRadius: '12px', padding: '10px'}}>
																				<button
																					...
																					onMouseEnter={e => {
																						...
																						// If mouse enters from left half, slide right; else slide left
